...
class RunLifecycleTests(unittest.TestCase):
    ...
    def test_v03_lupe_retains_analysis_and_adds_separate_genome_workspace(self) -> None:
        ...
        self.assertIn('/assets/v03.css', HTML)
        self.assertIn('/assets/v03.js', HTML)
        ...
        ui_script = (HERE / "assets" / "v03.js").read_text(encoding="utf-8")
        ui_style = (HERE / "assets" / "v03.css").read_text(encoding="utf-8")
    ...
    def test_genomes_are_deduplicated_and_ancestry_is_queryable(self) -> None:
        ...
        manifest = {
            "run_id": "test", "format_version": 2, "prototype_version": "0.3",
