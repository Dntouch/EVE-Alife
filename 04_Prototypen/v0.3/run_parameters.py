"""Zentrales Parameterschema und unveränderliche Startpresets für v0.3."""
...
PRESETS = {
    "v03-standard": {"label": "v0.3 Standard", "description": "Räumlicher Referenzlauf mit 128 Spielzeughabitaten und über den RAM verteilten Gründeramöben.", "values": {**{key: spec["default"] for key, spec in PARAMETERS.items()}, "label": "v0.3 Standard", "ram_world": "toys"}},
