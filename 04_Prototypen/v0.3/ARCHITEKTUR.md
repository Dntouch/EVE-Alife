# Architektur v0.3: EVE-Workstation auf langfristig beobachtbaren Runs

Prototyp v0.3 übernimmt Fachkern, Run-Format und Persistenzarchitektur von v0.2
...
Lupe und Supervisor von v0.3 sind ergänzend in `LUPE.md` und `SUPERVISOR.md`
