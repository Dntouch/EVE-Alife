...
PARAMETERS = {
    ...
    "aging_cost_rate": {"label": "Altersrate", "type": "float", "default": 0.005, "min": 0, "max": 1000000, "step": 0.001, "description": "Zusätzliche Standby-Kosten pro bereits gelebtem Heartbeat. Der v0.4-Standard 0,005 setzt den bewährten Langlauf-Tarif aus v0.3 fort; Null deaktiviert die altersabhängige Mehrbelastung."},
