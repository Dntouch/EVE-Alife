...
PARAMETERS = {
    ...
    "aging_cost_rate": {"label": "Altersrate", "type": "float", "default": 0.01, "min": 0, "max": 1000000, "step": 0.001, "description": "Zusätzliche Standby-Kosten pro bereits gelebtem Heartbeat. Der v0.4-Standard 0,01 verkürzt nach dem Populationsdurchbruch von Lauf 002 die sehr langen Lebensspannen alter Amöben; Null deaktiviert die altersabhängige Mehrbelastung."},
    ...
    "ram_world": {"label": "RAM-Welt", "type": "choice", "default": "toys", "choices": ["random", "islands", "bare", "toys"], "description": "Bare verteilt die Gründer mit lokalen Koordinaten über zufälligen RAM, erzeugt aber keinerlei Steine, Blasen oder Schalter. Toys ergänzt 128 Habitate. Random und Islands sind historische Modi mit absoluter Adressierung; ihre Gründer erscheinen räumlich gemeinsam bei RAM 0."},
...
BASE_RUN16 = {
    ...
    "aging_cost_rate": 0.005, "genome_node_cost": 0.05, "genome_edge_cost": 0.01,
