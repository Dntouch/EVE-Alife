#!/usr/bin/env python3
"""Supervisor für begrenzte und offene EVE-Alife-v0.2-Runs."""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="EVE-Alife Prototyp v0.2")
    ...
    with RunStore(run_dir, create=True) as store:
        ...
        if end_reason:
            ...
            final_live.update({"status": "extinct" if end_reason == "natural_extinction" else "completed", "end_reason": end_reason})
