...
- [v0.2 – aktuelle Versuchsreihe](v0.2/README.md): SQLite-Format 2, variable genomische Partnersuche, erweiterte Lupe und die ersten Versuche mit reduziertem Genomkostentarif.
