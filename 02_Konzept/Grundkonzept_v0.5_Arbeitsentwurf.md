...
EVE ist ein offenes Evolutionsexperiment mit extrem primitiven digitalen Entitäten. Sprache, menschliche Semantik, Wissen, Neugier, Kooperation, Forschung und Selbsterhaltung werden nicht als fertige Fähigkeiten eingebaut. Auch Stagnation, Exploits und vollständiges Aussterben sind gültige Ergebnisse.

Leitprinzip:

> So wenig wie möglich vorgeben. Alles technisch Unvermeidbare so elementar wie möglich halten.

Die Ausführung bleibt in einer abgeschotteten Versuchsumgebung. Supervisor, Sicherheitsgrenze und technische Schutzlimits liegen außerhalb der Evolution.
